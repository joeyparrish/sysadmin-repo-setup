...
Refer to the OS-specific file for commands — read only the one that matches
the target machine:

- **Linux:** [explore-linux.md](explore-linux.md)
- **Windows:** [explore-windows.md](explore-windows.md) — also covers the
  Windows Update procedure and gotchas for remote management
- **macOS:** [explore-macos.md](explore-macos.md)
...
- **Windows only** -- also document the Windows Update procedure; see
  [explore-windows.md](explore-windows.md) for the template and setup commands
